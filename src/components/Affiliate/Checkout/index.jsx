...
const Checkout = (props) => {
  ...
  const [showOrderConfirmation, setShowOrderConfirmation] = useState(false); // State to show OrderConfirmation
  ...
  return (
    <>
          ...
          <div className="max-w-[484px] mx-auto  px-4">
            <div className="border rounded-xl shadow-shadow1 border-gray p-6">
              ...
              <div class="flex items-center justify-between my-7">
                ...
                <span
                  href="#"
                  class="text-xs text-center text-t5 uppercase px-3"
                >
                  or
                </span>
                <span class="border-b border-gray flex-1"></span>
      ...
      <ConfirmAddressModal
        openModal={openModal}
        setOpenModal={setOpenModal} // Pass modal state and function to open/close modal
