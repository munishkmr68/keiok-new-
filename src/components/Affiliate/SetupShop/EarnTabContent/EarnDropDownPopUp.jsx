...
const language = [
  { name: "Manage MY office", value: "Manage MY office" },
  { name: "Personal sales pay", value: "Personal sales pay" },
  { name: "Level pay", value: "Level pay" },

];
const EarnDropDownPopUp = (props) => {
...
export default EarnDropDownPopUp;
