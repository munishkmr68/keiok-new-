...
import prdimage from "../../../assets/images/profile-product-img.png";
    ...
    <div className="border rounded-xl shadow-shadow1 border-gray p-6 overflow-hidden">
      <div className="max-w-[484px] mt-0 mb-[16px] px-4">
        <div className="flex flex-col items-center gap-1.5  ">
          <Image
            className="w-[168px] h-[100px] mb-6 "
            src={prdimage}
            alt="user-img"
          />
        </div>
        <h4 className="font-bold text-t4 text-center">MY lash</h4>
