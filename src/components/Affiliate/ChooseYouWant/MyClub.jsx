    ...
    <div className="border rounded-xl shadow-shadow1 border-gray p-6 overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-3">
            <div>
              <ul className="flex flex-col gap-0 sm:gap-1.5 ">
                ...
                <li className="text-[12px] font-bold sm:text-xs text-t1">
                  1-time setup bonus — $18.00
                </li>
                <li className="text-[17px] font-bold text-t1">Pay today</li>
              </ul>
            </div>
            <div>
              <ul className="flex flex-col gap-0 sm:gap-1.5 pl-[24px] sm:text-right">
                <li className="text-[10px] sm:text-xs text-t4">$38.00</li>
                <li className="text-[10px] sm:text-xs text-t4"> </li>
                <li className="text-[17px] font-bold text-t1 mt-5">$20.00</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col divide-y divide-dashed divide-gray mt-3 border-b border-dashed border-gray">
        <ul className="flex justify-between py-1.5">
          <li className="text-[12px] font-normal sm:text-xs text-t4 ">Size</li>
        ...
        <ul className="flex justify-between py-1.5">
          <li className="text-[12px] font-normal sm:text-xs text-t4 ">Items</li>
          <li className="text-[12px] font-normal sm:text-xs text-t4 ">1</li>
        </ul>
      </div>
