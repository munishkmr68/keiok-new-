...
export default function RestartMembership() {
  ...
  return (
    <>
      ...
      <div className="border rounded-xl shadow-shadow1 border-gray px-6 pt-8 mt-6 max-w-[484px] mx-auto px-4 mb-3">
        <div>
          <button type="button" className="pink-button font-medium flex-1 py-2">
            Restart membership
          </button>
        </div>
        ...
        <ul className="space-y-1 text-[13px] text-t4 font-medium mt-5">
          <li className="flex items-center gap-2">
            ...
            <span>
              ...
              <span className="underline">Lash Cycle</span>
            </span>
          </li>
        </ul>
                    ...
                    >
                      ...
                      {selectedPaymentMethod === "paypal" && (
                        <div className="mt-3">
                          ...
                          <button className="rounded-xl w-full flex items-center px-4 sm:px-6 gap-2.5  text-white py-3.5 bg-yellow mt-3">
                            <span className="mx-auto">
                              <Paypal />
                            </span>
                          </button>
