...
// const language = [
//   { name: "MY next order", value: "MY next order" },
//   { name: "MY lash product info", value: "MY lash product info" },
//   { name: "Change email", value: "Change email" },
//   { name: "Payment info", value: "Payment info" },
//   { name: "Shipping info", value: "Shipping info" },
//   { name: "Order history", value: "Order history" },
// ];
// const MyNextOrderModal = (props) => {
...
//   );
// };
// export default MyNextOrderModal;
